...
recipe "utilities::do_change_admin_password", "Changes the administrator password"
recipe "utilities::do_system_reboot", "Reboots the system"
recipe "utilities::do_system_shutdown", "Shuts down the system"
...
recipe "utilities::setup_scheduled_task_create", "Creates the 'rs_scheduled_task' scheduled task under the 'administrator' user. Uses the SCHTASKS Windows command"
recipe "utilities::setup_scheduled_task_delete", "Deletes the 'rs_scheduled_task' scheduled task under the 'administrator' user. Uses the SCHTASKS Windows command"

attribute "utilities/admin_password",
  :display_name => "New administrator password",
  :description => "New administrator password",
  :recipes => ["utilities::do_change_admin_password", "utilities::setup_scheduled_task_create"],
  :required => "required"

attribute "schtasks/command",
  :display_name => "Task command",
  :description => "Defines the shell command to run. (e.g., dir >> c:\\dir.txt)",
  :recipes => ["utilities::setup_scheduled_task_create"],
  :required => "required"
