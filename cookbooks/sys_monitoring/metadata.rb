...
recipe "sys_monitoring::file_stats", 'Monitors file size and last modified time in seconds'
recipe "sys_monitoring::process_stats", 'Monitors process and thread count'
...
attribute "sys_monitoring/monitor_files",
  ...
  :recipes => ["sys_monitoring::file_stats"],
  :required => "required"
...
attribute "sys_monitoring/monitor_processes",
  ...
  :recipes => ["sys_monitoring::process_stats"],
  :required => "required"