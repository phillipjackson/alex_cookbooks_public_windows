...
recipe "win_aws::download", "Retrieves a file from an S3 bucket"
recipe "win_aws::upload", "Uploads a file to an S3 bucket"


attribute "aws/access_key_id",
  :display_name => "Access Key Id",
  :description => "This is an Amazon credential. Log in to your AWS account at aws.amazon.com to retrieve you access identifiers. Ex: 1JHQQ4KVEVM02KVEVM02",
  :recipes => ["win_aws::do_register_instance_with_elb", "win_aws::do_deregister_instance_from_elb", "win_aws::download", "win_aws::upload"],
  :required => "required"
...
attribute "win_aws/file_path",
  ...
  :recipes => ["win_aws::upload"],
  :required => "required"
  
attribute "s3/file",
  :display_name => "File",
  :description => "File to be retrieved from the s3 bucket. Ex: app.zip",
  :recipes => ["win_aws::download"],
  :required => "required"

attribute "s3/bucket",
  :display_name => "Bucket",
  :description => "The name of the S3 bucket",
  :recipes => ["win_aws::download", "win_aws::upload"],
  :required => "required"
