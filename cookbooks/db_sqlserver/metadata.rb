...
recipe "db_sqlserver::do_backup_database", "Backs up a database to a local machine directory."
recipe "db_sqlserver::do_backup_database_to_s3", "Backs up a database to a local machine directory."
recipe "db_sqlserver::do_restore_database", "Restores a database from a local machine directory."
recipe "db_sqlserver::do_drop_database", "Drops a database."
recipe 'db_sqlserver::do_import_sql_dump_from_s3', 'Downloads an sql dump from an s3 bucket and imports it into the database.'
...
attribute "db_sqlserver/server_name",
  ...
  :recipes => ["db_sqlserver::do_import_sql_dump_from_s3", "db_sqlserver::do_backup_database", "db_sqlserver::do_backup_database_to_s3", "db_sqlserver::do_restore_database", "db_sqlserver::do_drop_database"],
  :required => "required"
...
attribute "db_sqlserver/backup/database_backup_dir",
  ...
  :recipes => ["db_sqlserver::do_backup_database", "db_sqlserver::do_backup_database_to_s3", "db_sqlserver::do_restore_database"]
...
attribute "db_sqlserver/backup/backup_file_name_format",
  ...
  :default => "{0}_{1}.bak",
  :recipes => ["db_sqlserver::do_import_sql_dump_from_s3", "db_sqlserver::do_backup_database", "db_sqlserver::do_backup_database_to_s3", "db_sqlserver::do_restore_database"]
...
attribute "s3/file",
  ...
  :recipes => ["db_sqlserver::do_import_sql_dump_from_s3"],
  :required => "required"
...
attribute "s3/bucket_backups",
  ...
  :description => "The name of the S3 bucket",
  :recipes => ["db_sqlserver::do_backup_database_to_s3"],
  :required => "required"
  
attribute "aws/access_key_id",
  :display_name => "Access Key Id",
  :description => "This is an Amazon credential. Log in to your AWS account at aws.amazon.com to retrieve you access identifiers. Ex: 1JHQQ4KVEVM02KVEVM02",
  :recipes => ["db_sqlserver::do_import_sql_dump_from_s3", "db_sqlserver::do_backup_database_to_s3"],
  :required => "required"
