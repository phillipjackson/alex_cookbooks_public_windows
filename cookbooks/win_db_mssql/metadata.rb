...
recipe 'win_db_mssql::default', 'AP: Loads the database and installs the BlogEngine application as the default IIS site'
recipe "win_db_mssql::backup_database", "Backs up a database to a local machine directory."
recipe "win_db_mssql::backup_database_to_s3", "Backs up a database to a local machine directory."
recipe "win_db_mssql::restore_database", "Restores a database from a local machine directory."
recipe "win_db_mssql::drop_database", "Drops a database."
...
attribute "db_sqlserver/server_name",
  ...
  :recipes => ["win_db_mssql::default", "win_db_mssql::backup_database", "win_db_mssql::backup_database_to_s3", "win_db_mssql::restore_database", "win_db_mssql::drop_database"],
  :required => "required"
...
attribute "db_sqlserver/backup/database_backup_dir",
  ...
  :recipes => ["win_db_mssql::backup_database", "win_db_mssql::backup_database_to_s3", "win_db_mssql::restore_database"]
...
attribute "db_sqlserver/backup/backup_file_name_format",
  ...
  :default => "{0}_{1}.bak",
  :recipes => ["win_db_mssql::default", "win_db_mssql::backup_database", "win_db_mssql::backup_database_to_s3", "win_db_mssql::restore_database"]
...
attribute "s3/bucket_backups",
  ...
  :description => "The name of the S3 bucket",
  :recipes => ["win_db_mssql::backup_database_to_s3"],
  :required => "required"
  
attribute "aws/access_key_id",
  :display_name => "Access Key Id",
  :description => "This is an Amazon credential. Log in to your AWS account at aws.amazon.com to retrieve you access identifiers. Ex: 1JHQQ4KVEVM02KVEVM02",
  :recipes => ["win_db_mssql::default", "win_db_mssql::backup_database_to_s3"],
  :required => "required"
